         ...
         @if(auth()->user()->role == "admin") {{-- admin--}}
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{ route('home') }}">
              <i class="ni ni-tv-2 text-primary"></i> COOL SMILES
            </a>
          </li>

          <li class="nav-item">
            <a class="nav-link" href="{{ url('/especialidades') }}">
              <i class="ni ni-planet text-blue"></i> Gestion de Servicios
            </a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{ url('/charts/doctors/column') }}">
              <i class="ni ni-circle-08 text-pink"></i> Medicos mas Activos
            </a>
          </li>
