      ...
      <div class="row mt-5">
        <div class="col-xl-12 mb-12 mb-xl-0">
          <div class="card shadow">
            ...
            {{--   <center>
                <a class="btn btn-sm btn-outline-danger mb-3" href="{{ url('espe') }}">PDF <i class="fas fa-file-pdf"></i></a>
              </center> --}}
              <!-- Projects table -->
              <table id="example" class="display">
                ...
                @foreach ($especialidades as $esp)
                    ...
                    <td>
                     <a class="btn btn-outline-primary"  href="javascript:void(0)" onclick="mostrar(<?php echo $esp->id; ?>)"><i class="fas fa-edit" style="color: blue; font-size: 16px; cursor: pointer;"></i></a>
                     
                     <a class="btn btn-outline-danger" href="javascript:void(0)" onclick="eliminar(<?php echo $esp->id; ?>)"><i class="fas fa-trash-alt"></i></a>
