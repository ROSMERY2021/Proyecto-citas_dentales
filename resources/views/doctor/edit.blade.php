             ...
             <div class="panel-body formregistros" style="margin: 20px;">
                ...
                @method('PUT')
            		...
            		<div class="form-group col-lg-5 col-md-5 col-sm-5 col-xs-12">
                          ...
                          <div class="form-group col-lg-5 col-md-5 col-sm-5 col-xs-12">
                            <label>DNI:</label>
                            <input type="number" class="form-control" name="dni" value="{{ old('dni',$doctor->dni) }}">
                            @if ($errors->has('dni'))
                          ...
                          <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
			                  ...
			                  <a class="btn btn-outline-danger" href="{{ url('doctor') }}" ><i class="fa fa-power-off"></i> Cancelar </a>
