...
Route::get('pdf',[App\Http\Controllers\Admin\DoctorController::class, 'pdf1']); 
Route::get('espe',[App\Http\Controllers\Admin\EspecialidadController::class,'pdf2']);
Route::get('paci',[App\Http\Controllers\Admin\PacienteController::class, 'pdf3']); 
